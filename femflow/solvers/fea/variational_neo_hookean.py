...
class VariationalNeoHookean(object):
    def __init__(
        self, v: np.ndarray, f: np.ndarray, t: np.ndarray, E: float, nu: float
    ):
        # Geometry
        self.v = v
        self.v0 = v
    ...
    def dphi_linear_tetrahedron_dX(self, element: np.ndarray) -> np.ndarray:
    ...
    def _neo_hookean_linear_tetrahedral(
        ...
        d_phi = self.dphi_linear_tetrahedron_dX(element)
        F = t * d_phi

    def dpsi_neo_hookean_dF(self, F: np.ndarray) -> np.ndarray:
    ...
    def d2psi_neo_hookean_dF(self, F: np.ndarray):
        F1_1 = F[0, 0]
        F1_2 = F[0, 1]
        F1_3 = F[0, 2]
        F2_1 = F[1, 0]
        ...
        ddw[0, 0] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F2_2 * F3_3 - F2_3 * F3_2, 2.0) * 2.0
        )
        ddw[0, 1] = (
            self.lambda_
            * (F1_2 * F3_3 - F1_3 * F3_2)
        ...
        ddw[1, 1] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F1_2 * F3_3 - F1_3 * F3_2, 2.0) * 2.0
        )
        ddw[1, 2] = (
            self.lambda_
            * (F1_2 * F2_3 - F1_3 * F2_2)
        ...
        ddw[2, 2] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F1_2 * F2_3 - F1_3 * F2_2, 2.0) * 2.0
        )
        ddw[2, 3] = (
            -self.mu
            * (
        ...
        ddw[3, 3] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F2_1 * F3_3 - F2_3 * F3_1, 2.0) * 2.0
        )
        ddw[3, 4] = (
            self.lambda_
            * (F1_1 * F3_3 - F1_3 * F3_1)
        ...
        ddw[4, 4] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F1_1 * F3_3 - F1_3 * F3_1, 2.0) * 2.0
        )
        ddw[4, 5] = (
            self.lambda_
            * (F1_1 * F2_3 - F1_3 * F2_1)
        ...
        ddw[5, 5] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F1_1 * F2_3 - F1_3 * F2_1, 2.0) * 2.0
        )
        ddw[5, 6] = (
            -self.mu
            * (
        ...
        ddw[6, 6] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F2_1 * F3_2 - F2_2 * F3_1, 2.0) * 2.0
        )
        ddw[6, 7] = (
            self.lambda_
            * (F1_1 * F3_2 - F1_2 * F3_1)
        ...
        ddw[7, 7] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F1_1 * F3_2 - F1_2 * F3_1, 2.0) * 2.0
        )
        ddw[7, 8] = (
            self.lambda_
            * (F1_1 * F2_2 - F1_2 * F2_1)
        ...
        ddw[8, 8] = (
            ...
            * (
            ...
            + self.lambda_ * pow(F1_1 * F2_2 - F1_2 * F2_1, 2.0) * 2.0
        )
