...
def p2g(
    ...
    for p in range(len(x)):
        ...
        affine = fixed_corotated_stress_2d(
        ...
        for i in range(3):
            for j in range(3):
                ...
                adpos = affine @ dpos
                grid_velocity[base_coord[0] + i, base_coord[1] + j] += weight * (
                    mv + adpos
                )
                grid_mass[base_coord[0] + i, base_coord[1] + j] += weight * mass
